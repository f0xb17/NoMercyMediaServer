...
namespace NoMercy.Server.Clients;
...
public class ApiClient
{
    ...
    public T? Put<T>(string url, HttpContent content)
    {
    ...
    public T? Patch<T>(string url, HttpContent content)
    {
