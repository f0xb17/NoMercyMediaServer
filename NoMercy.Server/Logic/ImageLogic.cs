...
public static class ImageLogic
{
    ...
    public class PaletteColors
    {
        ...
        public required string Dominant { get; set; }
        [JsonProperty("primary")]
        public required string Primary { get; set; }
        [JsonProperty("lightVibrant")]
        public required string LightVibrant { get; set; }
        [JsonProperty("darkVibrant")]
        public required string DarkVibrant { get; set; }
        [JsonProperty("lightMuted")]
        public required string LightMuted { get; set; }
