...
public class SpecialsController: BaseController
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var specials = await mediaContext.Specials
            .AsNoTracking()
        .ToListAsync();
    ...
    public async Task<IActionResult> Store()
    {
        ...
        {
            await using MediaContext mediaContext = new();
            var specials = await mediaContext.Specials.CountAsync();
    ...
    public async Task<IActionResult> Update(Ulid id, [FromBody] SpecialUpdateRequest request)
    {
        ...
        await using MediaContext mediaContext = new();
        var special = await mediaContext.Specials
    ...
    public async Task<IActionResult> Delete(Ulid id)
    {
        ...
        {
            await using MediaContext mediaContext = new();
            var special = await mediaContext.Specials.FindAsync(id);
    ...
    public async Task<IActionResult> RescanAll()
    {
        ...
        await using MediaContext mediaContext = new();
        var specialsList = await mediaContext.Specials
            .ToListAsync();
        ...
        foreach (var special in specialsList)
        {
            ...
            //
            // string[] paths = special.FolderSpecials
