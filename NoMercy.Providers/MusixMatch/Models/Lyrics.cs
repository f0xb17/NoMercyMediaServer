...
public class Lyrics
{
    ...
    [JsonProperty("check_validation_overridable")] public long CheckValidationOverridable { get; set; }
    [JsonProperty("locked")] public long Locked { get; set; }
    [JsonProperty("published_status")] public long PublishedStatus { get; set; }
    [JsonProperty("action_requested")] public string ActionRequested { get; set; }
    ...
    [JsonProperty("lyrics_body")] public string LyricsBody { get; set; }
    [JsonProperty("lyrics_language")] public string LyricsLanguage { get; set; }
    [JsonProperty("lyrics_language_description")] public string LyricsLanguageDescription { get; set; }
    ...
    [JsonProperty("backlink_url")] public Uri BacklinkUrl { get; set; }
