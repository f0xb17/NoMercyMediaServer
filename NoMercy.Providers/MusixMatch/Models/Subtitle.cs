...
public class Subtitle
{
    ...
    [Column("SubtitleBody")]
    [JsonProperty("subtitle_body"), System.Text.Json.Serialization.JsonIgnore]
    
    public string? _subtitle_body { get; set; }

    [NotMapped]
    public FormattedLyric[]? SubtitleBody
    {
        get => _subtitle_body is null ? null : JsonConvert.DeserializeObject<FormattedLyric[]>(_subtitle_body);
    ...
    [JsonProperty("subtitle_language_description")] public string SubtitleLanguageDescription { get; set; }
