...
public class Track
{
    ...
    [JsonProperty("album_coverart_100x100")] public Uri AlbumCoverart100X100 { get; set; }
    [JsonProperty("album_coverart_350x350")] public Uri AlbumCoverart350X350 { get; set; }
    [JsonProperty("album_coverart_500x500")] public Uri AlbumCoverart500X500 { get; set; }
    [JsonProperty("album_coverart_800x800")] public Uri AlbumCoverart800X800 { get; set; }
    [JsonProperty("track_share_url")] public Uri TrackShareUrl { get; set; }
    [JsonProperty("track_edit_url")] public Uri TrackEditUrl { get; set; }
    [JsonProperty("commontrack_vanity_id")] public string CommontrackVanityId { get; set; }
    [JsonProperty("restricted")] public long Restricted { get; set; }
    [JsonProperty("first_release_date")] public DateTimeOffset FirstReleaseDate { get; set; }
    [JsonProperty("updated_time")] public DateTimeOffset UpdatedTime { get; set; }
    [JsonProperty("primary_genres")] public Genres PrimaryGenres { get; set; }
    [JsonProperty("secondary_genres")] public Genres SecondaryGenres { get; set; }
}