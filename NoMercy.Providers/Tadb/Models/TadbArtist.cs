    ...
    public class TadbArtist
    {
        ...
        public List<TadbLanguageDescription> Descriptions
        {
            get
            {
                ...
                if (StrBiographyCN != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "CN", Description = StrBiographyCN });
                if (StrBiographyDE != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "DE", Description = StrBiographyDE });
                if (StrBiographyEN != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "EN", Description = StrBiographyEN });
                if (StrBiographyES != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "ES", Description = StrBiographyES });
                if (StrBiographyFR != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "FR", Description = StrBiographyFR });
                if (StrBiographyHU != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "HU", Description = StrBiographyHU });
                if (StrBiographyIL != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "IL", Description = StrBiographyIL });
                if (StrBiographyIT != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "IT", Description = StrBiographyIT });
                if (StrBiographyJP != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "JP", Description = StrBiographyJP });
                if (StrBiographyNL != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "NL", Description = StrBiographyNL });
                if (StrBiographyNO != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "NO", Description = StrBiographyNO });
                if (StrBiographyPL != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "PL", Description = StrBiographyPL });
                if (StrBiographyPT != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "PT", Description = StrBiographyPT });
                if (StrBiographyRU != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "RU", Description = StrBiographyRU });
                if (StrBiographySE != null) descriptions.Add(new TadbLanguageDescription { Iso31661 = "SE", Description = StrBiographySE });
