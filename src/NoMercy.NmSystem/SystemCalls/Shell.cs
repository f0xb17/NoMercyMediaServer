...
// public static class Shell
// {
//     public static async Task<string> Exec(string command, string arguments, string? cwd = null)
//     {
//         Process process = new()
//         {
//             StartInfo = new()
...
//     }
//     
//     public static string ExecSync(string command, string arguments, string? cwd = null)
//     {
//         TaskAwaiter<string> process = Exec(command, arguments, cwd).GetAwaiter();
//         return process.GetResult();
//     }
//     
//     public static async Task<string> ExecErr(string command, string arguments, string? cwd = null)
//     {
//         Process process = new();
//
//         process.StartInfo = new()
...
//     }
//     
//     public static string ExecErrSync(string command, string arguments, string? cwd = null)
//     {
//         TaskAwaiter<string> process = ExecErr(command, arguments, cwd).GetAwaiter();
//         return process.GetResult();
//     }
//     
//     
