...
namespace NoMercy.Database.Models
{
    ...
    public class Movie : ColorPaletteTimeStamps
    {
        ...
        [JsonProperty("crew")] public virtual ICollection<Crew> Crew { get; set; }
        [JsonProperty("genre")] public virtual ICollection<GenreMovie> GenreMovies { get; set; }
        [JsonProperty("keywords")] public virtual ICollection<KeywordMovie> KeywordMovies { get; set; }
        [JsonProperty("media")] public virtual ICollection<Media> Media { get; set; }
        ...
        [InverseProperty("MovieFrom")] public virtual ICollection<Recommendation> RecommendationFrom { get; set; }
        [InverseProperty("MovieTo")] public virtual ICollection<Recommendation> RecommendationTo { get; set; }
        [InverseProperty("MovieFrom")] public virtual ICollection<Similar> SimilarFrom { get; set; }
        [InverseProperty("MovieTo")] public virtual ICollection<Similar> SimilarTo { get; set; }
        
        [JsonProperty("video_files")] public virtual ICollection<VideoFile> VideoFiles { get; set; } = new HashSet<VideoFile>();
